...
class Inferencer:
    def __init__(self, device, huggingface_folder) -> None:
        self.device = device
...
if __name__ == '__main__':
    ...
    args.add_argument('-f', '--test_filepath', type=str,
                      help='It can be either the path to your audio file (.wav, .mp3) or a text file (.txt) containing a list of audio file paths.',default = "/app/duy55/zh_inference/samples/1.wav")
    args.add_argument('-s', '--huggingface_folder', type=str, default = 'DuyTa/ZH_pinyn',
